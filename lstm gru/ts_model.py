...
if __name__ == '__main__':
    train_file_path = r"dataset/total_cargo.csv"
    # select_features = ["pollution", "dew", "press", "wnd_spd"]
    data = pd.read_csv(train_file_path, header=0, index_col=0)["pre_total_sheet"].values
    train_data, test_data = divide_train_test(data)
    ts = ts_model(cuda=False,net="GRU",criterion="RMSELoss")
